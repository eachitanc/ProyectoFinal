                ...
                <div class="col-md-3">
                    ...
                    <div class="card" style="width: 15rem; height: 25rem;">
                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                            <img src='{{url("/img/$des->foto_producto")}}' class="img-fluid" id="img"/>
                            <a href="#!">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.15)"></div>
                            </a>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">{{$des->nom_producto}}</h5>
                            <p>$ {{$des->valor_producto}}</p>
                            <div class="row">
                                <div class="col-md-6">
                                    <div title="Agregar">
                                        <a href="{{route('comprarProd', $des->id_producto)}}" class="btn btn-success btn-sm" >
                                ...
                                <div class="col-md-6">
                                    <div title="Detalles">
                                        <a  href="{{route('detallesProd', $des->id_producto)}}"class="btn btn-primary btn-sm" value="Detalles">
